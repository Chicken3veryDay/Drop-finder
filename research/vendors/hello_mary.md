# Hello Mary vendor compliance and lab-source report

**Vendor ID:** `hello_mary`
**Verified:** 2026-07-15T02:25:00Z
**Canonical origin:** https://shophellomary.com
**Configured catalog route:** https://shophellomary.com/category/flower/
...
- Scope: `uncertain`
- Finding: No explicit public age gate or identity-verification mechanism was observable in the retrieved flower-category representation.
...
- Finding: No COA, lab report, or terpene document link was observed in the inspected category representation.
...
- `shophellomary.com`
- `www.shophellomary.com`

## Evidence ledger

- `storefront_or_category`: https://shophellomary.com/category/flower/ (observed, observed 2026-07-15T02:25:00Z)
  - No explicit public age gate or identity-verification mechanism was observable in the retrieved flower-category representation.

## Known limitations

- Category output does not prove the absence of product-page lab documents.
- Age behavior may be implemented in client-side state not exposed by the retrieved representation.
