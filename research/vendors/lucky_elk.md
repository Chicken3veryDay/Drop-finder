# Lucky Elk vendor compliance and lab-source report

**Vendor ID:** `lucky_elk`
**Verified:** 2026-07-15T02:25:00Z
**Canonical origin:** https://luckyelk.com
**Configured catalog route:** https://luckyelk.com/collections/thca-flower
...
- Scope: `site_entry`
- Finding: The public collection and COA pages display an Adults only (21+) enter/exit gate. This is self-attestation, not identity verification.
...
- Finding: A first-party COA Tests page exposes a THCA Flower section with public report links. Terpene coverage varies by report and is therefore classified partial rather than universal.

### First-party lab indexes

- https://luckyelk.com/pages/coa-tests

## Discovery and parsing strategy

- Discovery strategy: `central_index_gallery`
...
- `storefront_or_category`: https://luckyelk.com/collections/thca-flower (observed, observed 2026-07-15T02:25:00Z)
  - The public collection and COA pages display an Adults only (21+) enter/exit gate. This is self-attestation, not identity verification.
- `laboratory_index`: https://luckyelk.com/pages/coa-tests (observed, observed 2026-07-15T02:25:00Z)
  - A first-party COA Tests page exposes a THCA Flower section with public report links. Terpene coverage varies by report and is therefore classified partial rather than universal.

## Known limitations

- The report gallery uses image/document links whose visible labels may be sparse.
- Exact batch and variant mapping may require report-internal identifiers.
