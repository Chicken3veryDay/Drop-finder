# Pure Roots Botanicals vendor compliance and lab-source report

**Vendor ID:** `pure_roots_botanicals`
**Verified:** 2026-07-15T02:25:00Z
**Canonical origin:** https://purerootsbotanicals.com
**Configured catalog route:** https://purerootsbotanicals.com/product-category/thca-flower/
...
- Scope: `uncertain`
- Finding: No explicit age gate or identity-verification mechanism was observable in the retrieved category representation.
...
- Finding: No centralized COA, lab-results, or terpene-document link was observed in the inspected category representation.
...
- `purerootsbotanicals.com`
- `www.purerootsbotanicals.com`

## Evidence ledger

- `storefront_or_category`: https://purerootsbotanicals.com/product-category/thca-flower/ (observed, observed 2026-07-15T02:25:00Z)
  - No explicit age gate or identity-verification mechanism was observable in the retrieved category representation.

## Known limitations

- Product pages may expose changing report links not present on the category page.
- No checkout or account flow was accessed.
