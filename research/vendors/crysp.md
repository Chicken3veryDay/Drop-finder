# Crysp vendor compliance and lab-source report

**Vendor ID:** `crysp`
**Verified:** 2026-07-15T02:25:00Z
**Canonical origin:** https://crysp.co
**Configured catalog route:** https://crysp.co/thca-flower/
...
- Scope: `uncertain`
- Finding: No explicit public age-gate or identity-verification mechanism was observable in the retrieved category representation. Checkout was not accessed.
...
- COA availability: `partial`
- Terpene availability: `uncertain`
- Finding: The first-party flower category states products are lab-tested and have verified lab results, but no centralized report index or directly addressable document link was observed in the inspected category representation.
...
- `storefront_or_category`: https://crysp.co/thca-flower/ (observed, observed 2026-07-15T02:25:00Z)
  - No explicit public age-gate or identity-verification mechanism was observable in the retrieved category representation. Checkout was not accessed.

## Known limitations

- Lab claims were observed without a stable public central document index.
- Terpene document availability could not be confirmed without inspecting individual changing products.
