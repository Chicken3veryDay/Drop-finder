# Black Tie CBD vendor compliance and lab-source report

**Vendor ID:** `black_tie_cbd`
**Verified:** 2026-07-15T02:25:00Z
**Canonical origin:** https://www.blacktiecbd.net
**Configured catalog route:** https://www.blacktiecbd.net/collections/thca-flower
...
- Scope: `site_entry`
- Finding: The public collection and lab pages display an “Are you over 21 years old?” Yes/No gate. No public evidence of document or identity verification was observed.
...
- Finding: The first-party collection states each product has a product-specific COA, and the centralized lab page describes full-panel batch reports including potency and safety screens. Exotic-tier reports are described as including terpene breakdowns.

### First-party lab indexes

- https://www.blacktiecbd.net/pages/lab-results-and-coas
...
- `storefront_or_category`: https://www.blacktiecbd.net/collections/thca-flower (observed, observed 2026-07-15T02:25:00Z)
  - The public collection and lab pages display an “Are you over 21 years old?” Yes/No gate. No public evidence of document or identity verification was observed.
- `laboratory_index`: https://www.blacktiecbd.net/pages/lab-results-and-coas (observed, observed 2026-07-15T02:25:00Z)
  - The first-party collection states each product has a product-specific COA, and the centralized lab page describes full-panel batch reports including potency and safety screens. Exotic-tier reports are described as including terpene breakdowns.

## Known limitations

- The centralized page can be rendered behind the age-attestation UI.
- Exact report-to-variant mapping depends on product and batch labels exposed by the site.
