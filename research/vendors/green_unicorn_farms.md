# Green Unicorn Farms vendor compliance and lab-source report

**Vendor ID:** `green_unicorn_farms`
**Verified:** 2026-07-15T02:25:00Z
**Canonical origin:** https://greenunicornfarms.com
**Configured catalog route:** https://greenunicornfarms.com/category/thca-flower/
...
- Scope: `site_entry`
- Finding: The public category page displays a self-attested age prompt asking whether the visitor is over 21. The button text is internally inconsistent (“18 or Older”), so the result is retained with that limitation and not treated as identity verification.
...
- Finding: No centralized lab-report or COA link was observed in the inspected THCA category representation.
...
- `www.greenunicornfarms.com`

## Evidence ledger

- `storefront_or_category`: https://greenunicornfarms.com/category/thca-flower/ (observed, observed 2026-07-15T02:25:00Z)
  - The public category page displays a self-attested age prompt asking whether the visitor is over 21. The button text is internally inconsistent (“18 or Older”), so the result is retained with that limitation and not treated as identity verification.

## Known limitations

- Age-modal copy is inconsistent between the question and affirmative button.
- No centralized public lab index was found in the inspected category page.
