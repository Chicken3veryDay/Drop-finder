...
1. Read `README.md`, `AGENTS.md`, this document, the relevant deployment receipts, and every workflow capable of writing the affected `main`, `gh-pages`, or Pages state.
